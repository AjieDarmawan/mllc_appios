...
class Register_four_education extends StatefulWidget {
  //final List data;
  // final Map arguments;

  const Register_four_education({Key? key}) : super(key: key);

  @override
  _Register_four_educationState createState() =>
      _Register_four_educationState();
}

class _Register_four_educationState extends State<Register_four_education> {
  ...
  Widget _buildContent(context, userDetailInfo) {
    if (userDetailInfo['educations'].length > 0) {
      return Scaffold(
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: MaterialButton(
                              ...
                              color: kPrimaryColor,
                              child: Text(
                                  userDetailInfo['educations'].length >= 1
                                      ? "Next"
                                      : "Skip",
        ...
        //   onPressed: () {
        //     Navigator.of(context).push(MaterialPageRoute(
        //         builder: (context) => AccountEducationViewPage()));
        //   },
        //   tooltip: 'add',
