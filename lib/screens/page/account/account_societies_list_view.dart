...
class AccountSocietiesListViewPage extends StatelessWidget {
  final bool showEdit;
  final bool disableEdit;

  const AccountSocietiesListViewPage(
  ...
  Widget build(BuildContext context) {
    return BlocListener<AuthBloc, AuthState>(
      ...
      if (state is UpdateDataSuccessful) {
        _showSuccessMessage(context, 'Update Societies Successful');
      } else if (state is CreateDataSuccessful) {
        _showSuccessMessage(context, 'Create Societies Successful');
      } else if (state is ErrorOccured) {
        showDialog<String>(
            context: context,
            builder: (BuildContext context) => AlertDialog(
                  title: const Text('Societies Error'),
