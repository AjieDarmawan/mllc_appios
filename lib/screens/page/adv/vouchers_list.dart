...
class VouchersListPage extends StatefulWidget {
  ...
  const VouchersListPage({Key? key, this.data}) : super(key: key);
      ...
      onTap: () {
        ...
        if (userId != 0) {
          if (showExpired != true) {
            ...
            //     context, '/voucher_details_view_page',
            //     arguments: {'data': data});
        ...
        //             content: const Text(
        //                 'Need to login first only can view this voucher.'),
        //             actions: <Widget>[
        //               TextButton(
        //                 onPressed: () {
