...
class _AccountCompanyViewPageState extends State<AccountCompanyViewPage> {
            ...
            child: SingleChildScrollView(
              child: Column(children: [
                TextFieldWidget(
                  ...
                  validator: company_nameValidator,
                  // validator:
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      CustomSearchableDropDown(
                          ...
                          onChanged: (value) {
                            print("masuk--value${value}");
                            initArea = [];
                            _formData['expanding_areas'] = '';
                            if (value != null) {
                              print("masukasli--${value.length}");
                              print("masuk--${value.length}");
                              ...
                              print(
                                  "masuk--expending${_formData['expanding_areas']}");
                            } else {
                              print("masuk--keluar");
  ...
  final company_nameValidator = MultiValidator([
    RequiredValidator(errorText: 'Company Name is required'),
    MinLengthValidator(3, errorText: 'Company name min 3 long'),
  ]);
}
