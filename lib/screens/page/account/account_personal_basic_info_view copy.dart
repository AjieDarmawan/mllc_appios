...
class _AccountPersonalBasicInfoViewPageState
  ...
  void initState() {
    ...
    if (state is GetUserDetailsSuccessful) userData2 = state.userData[0];

    _formData['user_id'] = userData2['id'];
    _formData['title_id'] = userData2['title_id'];
    _formData['nationality_id'] = userData2['nationality_id'];
    _formData['state_id'] = userData2['state_id'];
    _formData['name'] = userData2['name'];
    _formData['preferred_name'] = userData2['preferred_name'];
    _formData['chinese_name'] = userData2['chinese_name'];
    _formData['identity_card'] = userData2['identity_card'];
    _formData['phone_number'] = userData2['phone_number'];
    _formData['passport_number'] = userData2['passport_number'];
    _formData['others_nationality'] = userData2['others_nationality'];
    _formData['others_state'] = userData2['others_state'];
    _formData['gender'] = userData2['gender'];
    _formData['introduction'] = userData2['introduction'];
    ...
    if (userData2['thumbnail'] != null) {
      thumbnail = userData2['thumbnail'];
    }
    membershipExpiryDate = userData2['expired_date'];
    membershipRenewalDate = userData2['renewal_date'];
